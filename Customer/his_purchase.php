                ...
                <table class="w-full border-collapse table" id="mytable">
                    ...
                    <tbody class="divide-y divide-gray-400 hover:divide-y-8">
                        ...
                        <td><img :src="'../assets/img/' + p.image" alt="Product Image" width="50" height="50"></td>
                            ...
                            <td class="py-2 px-4">
                                <!-- <button @click="histoDelete(p.id)" class="text-red-500 hover:text-red-700 focus:outline-none">
                                    <i class="fas fa-trash-alt mr-2"></i>
                                </button> -->
                                <!-- <button id="openModalButton" class="text-blue-500 hover:text-blue-700 ml-2 focus:outline-none" onclick="openRateModal()">
            ...
            <div id="rateModal" class="fixed inset-0 flex items-center justify-center z-50 hidden">
                <div class="bg-white w-1/2 p-4 rounded-lg shadow-lg relative">
                    ...
                    <div class="flex items-center mb-4">
                        <div class="mr-4">
                            <img src="<?php echo isset($_SESSION['image']) ? '../assets/img/' . $_SESSION['image'] : ''; ?>" alt="default" style="height:35px;width:35px;border-radius: 40px;">
                        </div>
                    ...
                    <form @submit.prevent="addReview">
                        ...
                        <button id="submitRating" type="submit" class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline-blue active:bg-blue-800">
                            Submit
                        </button>
                    </form>
                </div>
