        ...
        <div>
            <nav class="bg-white border-gray-200 dark:bg-gray-900">
                <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto relative">
                    ...
                    <!-- Profile Dropdown -->
                    <ul id="profile-menu" class="absolute mt-3 top-10 right-0 hidden bg-white text-gray-800 shadow-md rounded-lg w-48 space-y-2 py-2">
                        <li><a href="tracker.php"><i class="mr-2 text-blue-500 fas fa-map-marker-alt ml-5"></i>Order
                                Tracker</a></li>
          ...
          <li><a href="help_center.php"><i class="mr-2 text-purple-500 fas fa-question-circle ml-5"></i>Help Center</a></li>
                        ...
                        <li><a href="../includes/logout.php"><i class="mr-2 text-gray-500 fas fa-sign-out-alt ml-5"></i>Logout</a></li>
                    </ul>
                        ...
                        <div class="modal-content py-4 text-left px-6 flex-1">
                            ...
                            <div class="payment-method-container flex-1 bg-gray-100 py-4 px-6">
                                ...
                                <div class="mb-4">
                                    ...
                                    <select name="paymethod" v-model="paymentMethodModel" required class="form-select border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="mode-of-payment" onchange="displayQRCode()">
                                ...
                                <div id="proof-of-payment" class="hidden mt-5">
                                    <label class="block text-gray-700 text-sm font-bold mb-2" required>Proof of
                                        Payment</label>
                                    <input type="file" id="proofOfPaymentFile" @change="handleFileProofImg" name="image" accept="image/*">
                                </div>
                                <div class="text-center mt-5">
                                    <button @click="processPlaceOrder" class="bg-blue-500 text-white py-2 px-4 rounded hover:bg-blue-600 focus:outline-none">
                                        Place Order
                                    </button>

                                    <!-- Cancel button -->
                                    <button id="close-order-details" class="bg-gray-500 text-white py-2 px-4 rounded hover:bg-gray-600 ml-3 focus:outline-none">Cancel</button>
                                </div>
                            </div>
                        </div>
                    </div>
