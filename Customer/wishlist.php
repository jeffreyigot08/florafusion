        ...
        <div id="wishlist" class="mt-20">
                <div class="p-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 mx-auto mt-8 p-4">
                        <div class="bg-white rounded-lg shadow-md p-4 mb-20" v-for="w in wishlist">
                            <img :src="'/florafusionmarket/assets/img/' + w.product_image" alt="Plant Product" class="mx-auto h-40 rounded-md">
                            ...
                            <div class="flex justify-center mt-4 space-x-4">
                                ...
                                <button class="text-gray-500 hover:text-green-600 ml-2" @click="addToCart(w.product_ID)"><i class="fas fa-cart-plus"></i></button>
                            </div>
                        </div>
                    </div>
                </div>
