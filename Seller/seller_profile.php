    ...
    <div>
        <nav class="bg-white border-gray-200 dark:bg-gray-900">
          ...
          <li><a href="../includes/logout.php"><i class="mr-2 text-gray-500 fas fa-sign-out-alt ml-5"></i>Logout</a>
                ...
                <div class="items-center justify-between hidden md:flex md:w-auto md:order-1" id="mobile-menu-2">
                    <ul class="flex flex-col font-medium md:p-0  md:flex-row md:space-x-8 dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700"
        ...
        <div class="flex mt-16 justify-center bg-gray-200" v-for="seller in sellers">
            <div class="flex mt-5 mb-5">
                <div class="w-5/6 p-4 border rounded relative"
                    style="background-image: url('../assets/img/FloraFusion.jpg');">
                    ...
                    <div class="flex items-center justify-center relative z-10 mb-4">
                        <img :src="'../assets/img/' + seller.image" alt="Seller Picture"
                ...
                <div class="w-5/6 p-5">
                    <div class="mb-4">
                        <h3 class="text-lg font-semibold mb-2">Plants: <span class="font-bold">{{ productLength
                                }}</span></h3>
...
<div id="sp">
    <div class="flex mt-5 justify-center" v-for="s in sn">
        <div class="md:w-1/3 px-4">
            <div class="bg-white border border-gray-200 dark:bg-gray-800 dark:border-gray-700 rounded-lg p-4">
                ...
                <div class="mb-4">
                    ...
                    <p class="text-gray-700 dark:text-gray-300">{{ s.name }}</p>
                </div>
            </div>
        </div>
        <div class="md:w-1/3 px-4">
            <div class="bg-white border border-gray-200 dark:bg-gray-800 dark:border-gray-700 rounded-lg p-4">
                ...
                <div class="mb-4">
                    ...
                    <p class="flex items-center text-gray-700 dark:text-gray-300">
                        <i class="fas fa-map-marker-alt mr-2"></i> {{ s.permanent_add }}
                    </p>
                </div>
            </div>
        </div>
...
<script src="../assets/sellerService/sellerProfile.js"></script>
