      ...
      <div class="grid grid-cols-1 md:grid-cols-2 gap-8 mt-10">
        <div class="mt-10 ml-6">
          ...
          <div class="flex justify-center mt-10">
            <button
              class="text-white bg-green-800 hover:bg-green-900 focus:ring-4 mb-10 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center mr-2 dark:bg-blue-600 dark:hover-bg-blue-700 dark:focus:ring-blue-800">
              <i class="fas fa-shopping-cart w-5 h-5 mr-2 -ml-1"></i>
              <a id="OpenButton" href="seller_products.php" onclick="toggleModal('pleaseLoginModal', 'loginModal')"
                class="no-underline text-white">Shop now</a>
            </button>
          </div>
        </div>
          ...
          <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content p-4 relative">
              ...
              <div class="flex gap-2 pt-2 pb-3">
                <a @click="getSellerID(userID)" href="sellers_profile.php">
              ...
              <form>
                ...
                <div class="table">
                  <div class="table-row">
                    ...
                    <div class="table-cell">
                      <!-- <a href="#" class="text-gray-500 hover:text-red-500" name="wishlist" id="wishlist"
                        @click="addToWishlist(product_ID)"><i class="fas fa-heart"></i></a>
                    </div>
                    <div class="table-cell">
                      <a href="#" class="text-gray-500 hover:text-green-600 ml-2" @click="addToCart(product_ID)"><i
                    ...
                    <div class="border-t border-gray-300" style="max-height: 400px; overflow-y: auto;">
                      <div v-for="r in revs" class="d-flex flex-row align-items-center mb-4">
                        ...
                        <div class="mb-4">
                            ...
                            <button  @click="addReview">Write Comment</button>
                      </div>
                    </div>
                  </div>
                </div>
